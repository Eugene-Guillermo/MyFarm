...
public class FarmLot {
    ...
    public void dig(Player player) {
        ...
        {
            System.out.println("You tried to use the shovel. However, you do not find anything to dig.");
            player.spendCoin(7);
        }
    }

    /**
     * Determines if the given Player object can buy a seed and plant it in This
     * FarmLot
     * 
     * @param player given Player
     */
    ...
    /**
     * Displays on the terminal crucial information about the inside the FarmLot to
     * the player.
     */
    ...
    /**
     * Displays on the terminal the ASCII art of the inside the FarmLot to the
     * player.
     */
    public void display() {
        if (this.occupancy.equals("Crop")) // there is a crop inside the lot
