We would like to credit the following people. We used the image assests found in the following links.
...
- For items with a CC-BY, CC-BY-SA, OGA-BY, or GPL license, you must credit the original author(s) as well as bluecarrot16, link to the original submissions (above) and include a link back to this page <https://opengameart.org/content/lpc-crops>.
- For items licensed CC0, credit and link back to this page is appreciated, but not required. 

|                                    Item                                    | Other Authors |              Type             | Status | Other Licenses |
|----------------------------------------------------------------------------|---------------|-------------------------------|--------|----------------|
...
| Yuca / Cassava                                                             | DE            | Cassava                       | todo   |                |
| Carrots                                                                    | DE            | Carrot root (DE)              |        |                |
| Carrots                                                                    | JT            | Carrot root (DE)              |        |                |
| Parsnips                                                                   | JT            | Carrot root (DE)              |        |                |
| Radishes                                                                   | JT            | Carrot root (DE)              |        |                |
...
| Corn                                                                       | DE, JT        | Corn (DE)                     |        |                |
|----------------------------------------------------------------------------|---------------|-------------------------------|--------|----------------|
| Asparagus                                                                  |               | Asparagus plant               | todo   |                |
| Rhubarb                                                                    |               | Rhubarb / chard               | todo   |                |
| Romaine lettuce                                                            |               | Romaine lettuce               | todo   |                |
| Iceberg lettuce                                                            | RK            | Iceberg lettuce               | todo   |                |
| Kale                                                                       |               | Kale                          | todo   |                |
| Red cabbage / Purple cabbage                                               |               | Cabbage/Cauliflower/Broccoli  |        | CC0            |
| Green cabbage                                                              |               | Cabbage/Cauliflower/Broccoli  |        | CC0            |
| Celery                                                                     |               | Celery                        | todo   |                |
| Bok choy                                                                   |               | Bok choy                      | todo   |                |
| Fennel bulb                                                                |               | Fennel plant                  | todo   |                |
| Brussels sprouts                                                           |               | Brussels sprouts              | todo   |                |
...
| Blueberries                                                                |               | Blueberry bush                | todo   |                |
